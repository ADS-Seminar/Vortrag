...
\section{Einführung und Motivation} % TODO: Tabs jeweils durch 4 Leerzeichen ersetzen
...
\begin{frame}{Laufzeiten bei binären Suchbäumen}
	...
	\begin{table}
        ...
        %TODO: Zeilenweise aufdecken (oder markieren)
	    \end{tabular}
	\end{table}
\end{frame}
...
\begin{frame}{Probleme bei binären Suchbäumen}
    % TODO: Balancing -> Balancieren ("deutscherer" Begriff)
	\begin{itemize}
