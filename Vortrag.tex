...
\begin{frame}{Mulmuley Games}
    ...
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \only<9->{Zähle die Anzahl der Spieler, die größer sind als alle vorherigen und nach dem ersten Trigger gezogen wurden.}
    \only<10->{Wert des Spiels: Erwartungswert der Anzahl}
\end{frame}
